...
await page.evaluate(() => {
  ...
  dt.setData("text/html", "<p>Hi <span class=\"user-mention\" data-user-id=\"11\">@Iago</span> see <a class=\"stream\" data-stream-id=\"3\" href=\"/#narrow/channel/3-Verona\">#Verona</a> <span aria-label=\"smile\" class=\"emoji emoji-1f604\" role=\"img\" title=\"smile\">:smile:</span></p>");
