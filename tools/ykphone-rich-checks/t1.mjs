...
await sleep(3000);
console.log("compose open?", await page.evaluate(() => document.querySelector("#compose")?.style.display, ));
console.log(await page.evaluate(() => ({composing: !!document.querySelector("#compose .ykphone-rich-editor"), visible: document.querySelector(".ykphone-rich-editor")?.getBoundingClientRect().height})));
await page.click(".ykphone-rich-content").catch((e) => console.log("click fail", e.message));
await sleep(300);
